...
<dl>
   <dt>CSS Prefix</dt>
   <dd>Each CSS posiion rule generated is prefixed with the text entered. Prepending of basic id and class selectors is supportted. The following characters are allowed - <em>a-z</em>, <em>0-9</em>, <em>_</em>, <em>-</em>, <em>#</em> and <em>.</em></dd>
